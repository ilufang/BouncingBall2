...
//  remaining2 = 1 - consumed2;
  remaining1 = 1 - k/interval;
  remaining2 = 1 - k/interval;
  ...
  b2.x = x2;
  b2.y = y2;
  println("ball moved from " + origb1x + ";" + origb1y + " to " + b1.x + ";" + b1.y);
  println("ball moved from " + origb2x + ";" + origb2y + " to " + b2.x + ";" + b2.y);
